...
namespace ExpenseProcessingSystem.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult GenerateFilePreview(HomeReportViewModel model)
        {
            ...
            //Assign variables and Data to each Report Type
            ...
            {
                return OutputPDF(layoutName, data, fileName);
        ...
        public IActionResult OutputPDF(string LayoutName, IEnumerable<TEMP_HomeReportOutputModel> data, string fileName)
        {

$(document).ready(function () {
    ...
    var WARNING4 = "This action will also reject related transactions that has an ERROR status.";
    ...
    $('table').on('click', '.btnReject', function () {
        ...
        msg = "REJECT";
        warning.push(WARNING4);

        ShowConfirmPopup(msg, warning, 4);
        $('#selectedPID').val(pid);
    });
